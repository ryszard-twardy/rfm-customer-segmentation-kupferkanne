...
└──────────────────┘    └──────────────────┘    └──────────────────┘
   80 CSV files            30 BQ objects           7-page dashboard
   ~440K records           (11 tables + 19 views)  7 pages, 47 DAX
```
...
| Linting | SQLFluff 4.1.0 | Custom rule policy |
