...
The cleaning pipeline (step 01) demonstrates handling these issues end-to-end. Generating data this way (rather than using a pristine Kaggle dataset) creates a genuine cleaning workload while keeping reproducibility under the author's control. See [ADR 0008](adr/0008-synthetic-data-with-realistic-quality-issues.md).
